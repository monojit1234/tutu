...
public class Assignment2 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		dvr.findElement(By.xpath("//*[@id='join-light']/form/div/div[1]/input")).sendKeys("monojit@yahoo.com");	//PASS THE USER NAME
		dvr.findElement(By.xpath("//*[@id='join-light']/form/div/div[2]/input")).sendKeys("Monojit@123");					//PASS THE PASSWORD
		...
		System.out.println("Execution of Assignment2 Completed");
	}
